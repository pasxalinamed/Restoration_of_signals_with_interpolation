function x_restored=gibbs_sampler_image_restoration(x_damaged,iters,burnIn)

% The function GIBBS_SAMPLER_IMAGE_RESTORATION implements the gibbs sampler
...
global order N zSize w L mstart mplusl y1 y2 D B 
